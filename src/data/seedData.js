...
export const DRIVERS = [
  ...
  { name: 'Isack Hadjar', team: 'Red Bull Racing', code: 'HAD' },
  { name: 'George Russell', team: 'Mercedes', code: 'RUS' },
  { name: 'Kimi Antonelli', team: 'Mercedes', code: 'ANT' },
  { name: 'Alex Albon', team: 'Williams', code: 'ALB' },
  { name: 'Carlos Sainz', team: 'Williams', code: 'SAI' },
  { name: 'Nico Hülkenberg', team: 'Audi', code: 'HUL' },
  { name: 'Gabriel Bortoleto', team: 'Audi', code: 'BOR' },
  { name: 'Fernando Alonso', team: 'Aston Martin', code: 'ALO' },
  { name: 'Lance Stroll', team: 'Aston Martin', code: 'STR' },
  { name: 'Pierre Gasly', team: 'Alpine', code: 'GAS' },
  { name: 'Franco Colapinto', team: 'Alpine', code: 'COL' },
  { name: 'Esteban Ocon', team: 'Haas', code: 'OCO' },
  { name: 'Oliver Bearman', team: 'Haas', code: 'BEA' },
  { name: 'Liam Lawson', team: 'Racing Bulls', code: 'LAW' },
  { name: 'Arvid Lindblad', team: 'Racing Bulls', code: 'LIN' },
  { name: 'Sergio Pérez', team: 'Cadillac', code: 'PER' },
  { name: 'Valtteri Bottas', team: 'Cadillac', code: 'BOT' },
